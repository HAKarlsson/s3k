 ...
 *         ERR_INVALID_ACCESS if the owner does not match the entry in the memory table.
 */
int mem_get(mem_table_t *mt, pid_t owner, index_t i, mem_t *mem_t);
 ...
 * @param index The index in the memory mt of the existing capability.
 ...
 */
int mem_derive(mem_table_t *mt, pid_t owner, index_t i, pid_t child_pid, fuel_t child_fuel, mem_perm_t child_rwx, mem_addr_t child_base,
